    ...
    <SafeAreaView style={[styles.container, { backgroundColor }]}>
      ...
      >
        <View style={styles.content}>
          <ThemedText style={styles.title}>Consulta IA</ThemedText>
          <ThemedText style={styles.subtitle}>
            Consulta médica 24/7 disponible
          </ThemedText>
          <ThemedText style={styles.description}>
            Aquí podrás chatear con nuestro asistente médico IA para consultas
            generales y obtener respuestas inmediatas sobre tu salud.
          </ThemedText>
        </View>
      </ScrollView>
    </SafeAreaView>
